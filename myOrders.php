...
<?php
    ...
    $queryToGetResult = "SELECT * FROM orders INNER JOIN product ON product.product_id = orders.product_id WHERE user_id = '$user_id'";
    ...
    if(count($rows) == 0){
        echo "<h1 style=\"text-align:center;margin-top:100px;font-size: 100px\">You don't have any bookmarks</h1></div>";
    }
    else{
        ...
        echo '
            ...
            <div style="padding-top: 40px;padding-left: 30px;" class="col-lg-8">
                ...
                <p>Order status: ' . $rows[$i]['status'] . '</p>
                <br>
            </div>
            </div>
            <hr>';
